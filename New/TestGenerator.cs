...
namespace ClassTestGenerator
{
    internal static class TestGenerator
    {
        public static string GenerateUnitTests(string sourceCode)
        {
            ...
            {
                AppendClassTests(sb, classDecl, classes, namespaceName);
            }
        ...
        private static string GetSampleValue(string type, bool isCollection, List<ClassDeclarationSyntax> allClasses)
        {
            if (isCollection)
