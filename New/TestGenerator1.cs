...
namespace ClassTestGenerator
{
    internal static class TestGenerator
    {
        public static string GenerateUnitTests(string sourceCode)
        {
            ...
            // Basic compilation with common references (useful if you later need semantic info)
            ...
            List<ClassDeclarationSyntax> allClasses)
        {
            ...
            string ctorArrange = GenerateCtorArrange(className, publicCtors, allClasses, hasDefaultCtor);
            ...
            sb.Append(GenerateMethodTests(className, methods, hasDefaultCtor, allClasses));
